...
class RoverState():
    def __init__(self):
        ...
        self.rock_in_view = False
        self.rock_in_distance = None
        self.console = None
        self.terrain_navigable = None
        self.clear_forward = False
        self.current_steer = None
        self.left_ahead_pixels = None
        self.right_ahead_pixels = None
